...
const makeLimiterResponseMsg = (retryAfter) => {
  const why = 'This keeps the service running smoothly for everyone. '
    + 'You can get around these limits by running your own instance of   AI Secure  Hub.';
...
if (process.env.DISABLE_GUI && process.env.DISABLE_GUI !== 'false') {
  app.get('*', async (req, res) => {
    ...
    const htmlContent = placeholderContent.replace(
      '<!-- CONTENT -->',
      '  AI Secure  Hub API is up and running!<br />Access the endpoints at '
...
const printMessage = () => {
  console.log(
    `\x1b[1m\x1b[32m AI Secure  Hub is up and running at http://localhost:${port} \x1b[0m\n\n`,
    ` Found AI Secure  Hub useful? Consider sponsoring us to help fund maintenance & development.\x1b[0m\n`,
    '_________        ___.                 _________                                    ___ ___      ___.    \n',
    '\\_   ___ \\___.__.\\_ |__   ___________/   _____/ ____   ____  __ _________   ____  /   |   \\ __ \\_ |__  \n',
    '/    \\  \\<   |  | | __ \\_/ __ \\_  __ \\_____  \\_/ __ \\_/ ___\\|  |  \\_  __ \\_/ __ \\/    ~    \\  |  \\ __ \\ \n',
    '\\     \\___\\___  | | \\_\\ \\  ___/|  | \\/        \\  ___/\\  \\___|  |  /|  | \\/\\  ___/\\    Y    /  |  / \\_\\ \\\n',
    ' \\______  / ____| |___  /\\___  >__| /_______  /\\___  >\\___  >____/ |__|    \\___  >\\___|_  /|____/|___  /\n',
    '        \/\/          \/     \/             \/     \/     \/                   \/       \/           \/ \n'
  );
};
